            ...
            else if (General.Page == "Foodcourt")
            {
                ...
                if (frm != null)
                {
                    ...
                    if (fc != null)
                    {
                        ...
                        ComboBox cbTenant = fc.Controls.Find("cbTenant", true).FirstOrDefault() as ComboBox;
                        TextBox txtSearch = fc.Controls.Find("txtSearch", true).FirstOrDefault() as TextBox;
                        ...
                        if (ListMenu != null && cbTenant != null && txtSearch != null)
                        {
                            var dataMenu = f.GetBarangSearchMenu(cbTenant.Text, txtSearch.Text);
